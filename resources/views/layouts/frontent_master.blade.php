...
<head>
    ...
    <!-- Css Styles -->
    <link rel="stylesheet" href="{{ asset('frontent') }}/css/bootstrap.min.css" type="text/css">
    <link rel="stylesheet" href="{{ asset('frontent') }}/css/font-awesome.min.css" type="text/css">
    <link rel="stylesheet" href="{{ asset('frontent') }}/css/elegant-icons.css" type="text/css">
    <link rel="stylesheet" href="{{ asset('frontent') }}/css/nice-select.css" type="text/css">
    <link rel="stylesheet" href="{{ asset('frontent') }}/css/jquery-ui.min.css" type="text/css">
    <link rel="stylesheet" href="{{ asset('frontent') }}/css/owl.carousel.min.css" type="text/css">
    <link rel="stylesheet" href="{{ asset('frontent') }}/css/slicknav.min.css" type="text/css">
    <link rel="stylesheet" href="{{ asset('frontent') }}/css/style.css" type="text/css">
</head>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__right">
                            ...
                            <div class="header__top__right__language">
                                ...
                                <div>Engl{{ asset('frontent') }}ish</div>
                                <span class="arrow_carrot-down"></span>
                                <ul>
                                    <li><a href="#">Spanis</a></li>
                                    <li><a href="#">English</a></li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="hero__item set-bg" data-setbg="{{ asset('frontent') }}/img/hero/banner.jpg">
