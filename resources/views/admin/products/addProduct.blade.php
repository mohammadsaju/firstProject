...
<form action="{{ url('store/product') }}" method="POST" enctype="multipart/form-data">
   ...
   <div class="card pd-20 pd-sm-40">
    ...
    <p class="mg-b-20 mg-sm-b-30">you can add any product from here</p>
      ...
      <div class="row mg-b-25">
        ...
        <div class="col-lg-4">
          <div class="form-group">
            ...
            <input class="form-control" type="number" name="product_code" value="{{ old('product_code') }}" placeholder="product code">
        ...
        <div class="col-lg-4">
          <div class="form-group">
            ...
            <input class="form-control" type="number" name="product_price" value="{{ old('product_price') }}" placeholder="product price">
